  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
              ...
              <span className="px-2 py-0.5 text-xs font-medium bg-sky-100 text-sky-700 rounded">FREE</span>
            </Link>
            <div className="hidden sm:flex items-center space-x-2 text-xs text-gray-600">
              <span className="px-3 py-1 bg-sky-50 text-sky-700 rounded-full font-medium">
                PDF
              </span>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Info Banner */}
        <div className="bg-gradient-to-r from-sky-50 via-blue-50 to-cyan-50 border border-sky-200/50 rounded-2xl p-6 mb-8 shadow-sm">
